...
class Gicam:
    ...
    def _build_dataset(self,
        ...
        n_iterations_pathogenic_dataset = max(int((dataset_loader.dlen_train - dataset_loader.amount_train_pathogenic_samples) / dataset_loader.amount_train_pathogenic_samples), 1)
