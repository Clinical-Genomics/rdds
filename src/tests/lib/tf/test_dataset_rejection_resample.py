...
@pt.fixture
def hd5_data_generator(hd5_file_path_with_categorical_labels: str) -> Hd5DataGenerator:
...
@pt.mark.parametrize("expected_negative_ratio, expected_positive_ratio",
                     [(1.00, 0.00),
                      ...
                      (0.75, 0.25),
                      (0.00, 1.00)])
def test_balanced_sampling(expected_negative_ratio: float,
                           expected_positive_ratio: float,
                           hd5_data_generator: float,
